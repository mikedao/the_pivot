...
class AdminUserTest < ActionDispatch::IntegrationTest
  ...
  def setup
    ...
    @project1 = category1.projects.create(title: 'espresso', description: "this is black gold", price: 30000)
    @project2 = category2.projects.create(title: 'cold pressed coffee', price: 8000, description: "hipster nonsense", price: 20000)
  end
  ...
  test "an admin can view all the orders" do
    ...
    @project = @order.projects.create(title: 'coffee', description: 'black nectar of the gods', price: 1200)
  ...
  test "an admin can retire an project" do
    ApplicationController.any_instance.stubs(:current_user).returns(user)
    Project.destroy_all
    @project = Project.create(title: 'coffee', description: 'black nectar of the gods', price: 1200, retired: false)
