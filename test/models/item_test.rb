...
class ItemTest < ActiveSupport::TestCase
  ...
  test "it cannot have a duplicate title" do
    ...
    @item1 = category.items.create(title: 'espresso', description: "this is bleck gold", price: 20000)
    @item2 = category.items.create(title: 'espresso', description: "this is back gold", price: 30000)
  ...
  test "it has to have a category" do
    skip
    #this refute should work. thre's no category. but it doesn't work right now
    item = Item.create(title: 'espresso', description: "this is black gold", price: 30000)
    refute item.valid?

    category = Category.create(name: "merchandise")
    item1 = category.items.create(title: 'espressos', description: "tthis is black gold", price: 30000)
    refute_equal nil, item1.categories
  end
end
