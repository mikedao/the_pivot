...
Tenant.create!(
  ...
  organization:          "Child Laborers Inc."
)

4.times do |n|
  location =              "East Timor represent#{n+1}"
  organization =          "Child Laborers Inc#{n+1}"
  Tenant.create!(
    location:             location,
...
Admin.create!(
        username: "Mugabe4Eva",
        password: "password",
        email:    "IExploitedMyPeople@hotmail.com"
      )
...
#items
timmys_vaccines_nigeria = people_category.items.create!(
...
stevens_books_bangkok = people_category.items.create!(
                                        title: "Steven's school books",
                                        price: 4000,
                                        description: "How can I teach deez kidddsss?",
                                        retired: false
                                        )

johns_waterworks_cotedivore = public_category.items.create!(
...
ashwins_conflict_diamonds_ivorycoast = conflict_zone_category.items.create!(
                                                                      title: "Ashwins exploitation of labor",
                                                                      price: 16000,
...
#Orders with items
ronald_order_1 = timmys_vaccines_nigeria.orders.create!(
                                                  total_cost: timmys_vaccines_nigeria.price,
                                                  user_id:    ronald1.id,
                                                  status:     "ordered"
                                                  )

ronald_order_2 = stevens_books_bangkok.orders.create!(
                                              total_cost: stevens_books_bangkok.price,
                                              user_id:    ronald2.id,
                                              status:     "ordered"
                                              )

ronald_order_3 = johns_waterworks_cotedivore.orders.create!(
